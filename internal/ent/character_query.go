...
func (_q *CharacterQuery) Modify(modifiers ...func(s *sql.Selector)) *CharacterSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *CharacterSelect) Modify(modifiers ...func(s *sql.Selector)) *CharacterSelect {
