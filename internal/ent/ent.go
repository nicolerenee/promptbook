...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			manualimportqueue.Table:    manualimportqueue.ValidColumn,
			performer.Table:            performer.ValidColumn,
			profile.Table:              profile.ValidColumn,
			recording.Table:            recording.ValidColumn,
			recordingimagechoice.Table: recordingimagechoice.ValidColumn,
			recordingversion.Table:     recordingversion.ValidColumn,
			show.Table:                 show.ValidColumn,
			syncrun.Table:              syncrun.ValidColumn,
			wantsentry.Table:           wantsentry.ValidColumn,
		})
	})
