...
func TestMatchCorpus(t *testing.T) {
	...
	rows := []rec{
		...
		{4, 102, "Company", "Springfield Philharmonic Concert", "2011-04-01", ""},
		{5, 102, "Company", "Second US National Tour", "2023-11-11", ""},
		...
		{15, 109, "Six", "Second US National Tour (Coastal)", "2024-06-15", ""},
	...
	tests := []struct {
		...
		{name: "Company 2023 day", in: "Company 2023-11-11.mp4",
		...
		{name: "Greenwich Beacon", in: "Greenwich Beacon 2024-6-7.mp4",
		...
		{name: "Six 2024 day", in: "Six 2024-6-15.mp4",
