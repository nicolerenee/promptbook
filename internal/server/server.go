...
type Options struct {
	DB     *sql.DB
	Logger zerolog.Logger
	// Stagemedia is the optional StageMedia.me client used to enrich the
	// recording detail page with curated posters. When nil, detail pages
...
// Stagemedia returns the optional stagemedia client. Nil when the
// server was constructed without one, in which case poster lookups
// short-circuit.
